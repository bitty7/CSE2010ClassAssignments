    ...
    */
    ...
    while(!feof(input_actions)){ // while the file is not empty
        ...
        */
        ...
        if ( strcmp(command, "WantToBefriend") == 0){

            /*
             scan the user name and the target name, then set path equals to the result of find_path()
             then print the required beginning of the line
            */
            ...
            if (stack_size > 0){ // enter if the stack size is more than zero

                /*
                 print the length of the path, then go to to next until the last node in the path
                */
                ...
                /*
                 print the intermediate friend of the stack size if three or more,
                 otherwise print it is the mutual friend
                */
                if (stack_size >= 3){
                ...
                /*
                 print the path from the user to the person they want to be friend with
                */
                printf("- path:");
                while (path != NULL) {
                ...
                /*
                 if stack size is zero or less, then print that there is no connection between the two users
                */
